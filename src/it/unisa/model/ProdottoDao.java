...
public class ProdottoDao implements ProdottoDaoInterfaccia{
	...
	public synchronized ArrayList<ProdottoBean> doRetrieveAll(String order) throws SQLException {
	    ...
	    List<String> validOrders = Arrays.asList("ID_PRODOTTO", "NOME", "DESCRIZIONE", "PREZZO", "QUANTITA", "PIATTAFORMA", "IVA", "DATA_USCITA", "IN_VENDITA", "IMMAGINE", "GENERE", "DESCRIZIONE_DETTAGLIATA");

	    String selectSQL = "SELECT * FROM " + ProdottoDao.TABLE_NAME;

	    if (order != null && !order.equals("") && validOrders.contains(order.toUpperCase())) {
